...
public class BluePlayerClass extends AbstractPlayerClass{
     ...
     */
    public BluePlayerClass(int x, int y, String team){
        super(x,y,team);
    }
    ...
    public boolean winFight(String type) {
        return type.equals(Game.BLUE) || type.equals(Game.GREEN);
    }
}
